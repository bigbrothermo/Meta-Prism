...
gpu: gpu-code/make_index.cpp gpu-code/add_index.cppp gpu-code/query_index.cpp
	g++ -o bin/make_index gpu-code/make_index.cpp -l pthread
        g++ -o bin/add_index gpu-code/add_index.cpp  -l pthread
        g++ -o bin/add_sam gpu-code/add_sam.cpp -l pthread
        g++ -o bin/query_index gpu-code/query_index.cpp -l pthread
